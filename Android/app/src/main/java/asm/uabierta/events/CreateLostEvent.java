...
public class CreateLostEvent {
    ...
    public CreateLostEvent(boolean withError, String message) {
        this.withError = withError;
        this.message = message;
    }

    public CreateLostEvent(boolean withError, SingleIdResponse response, String caseEvent) {
        this.withError = withError;
