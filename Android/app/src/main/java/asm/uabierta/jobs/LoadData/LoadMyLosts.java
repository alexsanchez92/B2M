 ...
 */
public class LoadMyLosts extends Job {
    private final String TAG = "LoadLosts Job";
    private LoadLostsListener mListener;
    private int id, limit, page;

    public LoadMyLosts(LoadLostsListener listener, int id, int limit, int page) {
    ...
    public void onRun() throws Throwable {
        ...
        Call<LostsResponse> call = service.LoadLosts(id, limit, page);
    ...
    interface Service {
        @GET("users/{id}/lost")
        Call<LostsResponse> LoadLosts(@Path("id") int id, @Query("limit") int limit, @Query("page") int page);
    }
}