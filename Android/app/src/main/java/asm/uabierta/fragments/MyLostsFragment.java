...
import asm.uabierta.jobs.LoadData.LoadMyLosts;
...
public class MyLostsFragment extends Fragment implements LoadLostsListener {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        jobManager.addJobInBackground(new LoadMyLosts(MyLostsFragment.this, Integer.parseInt(uP.getId()),  Constants.limit, page));
    }
