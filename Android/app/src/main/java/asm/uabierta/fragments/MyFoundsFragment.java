...
import asm.uabierta.jobs.LoadData.LoadMyFounds;
...
public class MyFoundsFragment extends Fragment implements LoadFoundsListener {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        jobManager.addJobInBackground(new LoadMyFounds(MyFoundsFragment.this, Integer.parseInt(uP.getId()), Constants.limit, page));
    }
