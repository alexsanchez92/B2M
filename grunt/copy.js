module.exports = {
    dashv: {
        files: [
            {expand: true, src: "**", cwd: 'bower_components/bootstrap/fonts', dest: "dashv/assets/fonts"},
            {expand: true, src: "**", cwd: 'bower_components/font-awesome/fonts', dest: "dashv/assets/fonts"},
            {expand: true, src: "**", cwd: 'bower_components/themify-icons/fonts', dest: "dashv/assets/css/fonts"},
            {expand: true, src: "**", cwd: 'DASHBOARD/templates',     dest: "dashv/templates"},
            {expand: true, src: "**", cwd: 'DASHBOARD/assets/api',     dest: "dashv/assets/api"},
            {expand: true, src: "**", cwd: 'DASHBOARD/assets/i18n',    dest: "dashv/assets/i18n"},
            {expand: true, src: "**", cwd: 'DASHBOARD/assets/images',     dest: "dashv/assets/images"},
            {expand: true, src: "**", cwd: 'DASHBOARD/assets/js/config',      dest: "dashv/assets/js/config"},
            {expand: true, src: "**", cwd: 'DASHBOARD/assets/js/directives',      dest: "dashv/assets/js/directives"},
            {expand: true, src: "**", cwd: 'DASHBOARD/assets/js/controllers',      dest: "dashv/assets/js/controllers"},
            {expand: true, src: "**", cwd: 'DASHBOARD/assets/js/filters',      dest: "dashv/assets/js/filters"},
            {expand: true, src: "**", cwd: 'DASHBOARD/assets/js/services',      dest: "dashv/assets/js/services"},
            {expand: true, src: "**", cwd: 'DASHBOARD/assets/views',     dest: "dashv/assets/views"},
            {expand: true, src: "**", cwd: 'DASHBOARD/assets/css/themes',     dest: "dashv/assets/css/themes"},
            {src: 'DASHBOARD/master/_index.min.html', dest : 'dashv/index.html'},
            {src: 'DASHBOARD/uploadPad.php', dest : 'dashv/uploadPad.php'},
            {src: 'DASHBOARD/upload.php', dest : 'dashv/upload.php'}
        ]
    },
    standardversion: {
        files: [
