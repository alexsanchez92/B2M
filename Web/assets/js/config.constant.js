...
app.constant('JS_REQUIRES', {
    ...
    scripts: {
        ...
        //*** Controllers
        'indexCtrl': 'assets/js/controllers/indexCtrl.js',
        'loginCtrl': 'assets/js/controllers/loginCtrl.js',
        'myObjectsCtrl': 'assets/js/controllers/myObjectsCtrl.js',
        'searchCtrl': 'assets/js/controllers/searchCtrl.js',
        'editCtrl': 'assets/js/controllers/editCtrl.js',
        ...
        //*** Custom Services
        'getServices': 'assets/js/services/getServices.js',
